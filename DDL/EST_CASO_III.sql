CREATE SCHEMA SISTEMA_DE_GESTAO_EMPRESARIAL1;
...
ID_ENDERECO INT,
CONSTRAINT FK_ID_ENDERECO_CLIENTES FOREIGN KEY (ID_ENDERECO)
...
ID_ENDERECO INT,
ID_CARGO INT,
CONSTRAINT FK_ID_ENDERECO_EMPREGADOS FOREIGN KEY (ID_ENDERECO)
REFERENCES ENDERECOS (ID_ENDERECO),
...
ID_ENDERECO INT,
CONSTRAINT FK_ID_ENDERECO_EMPRESAS FOREIGN KEY (ID_ENDERECO)
REFERENCES ENDERECOS (ID_ENDERECO)
);
...
ID_ENDERECO INT,
CONSTRAINT FK_ID_ENDERECO_FORNECE FOREIGN KEY (ID_ENDERECO)
REFERENCES ENDERECOS (ID_ENDERECO)
);
...
ID_CLIENTE INT,
CONSTRAINT FK_ID_CLIENTEE FOREIGN KEY (ID_CLIENTE)
REFERENCES CLIENTES (ID_CLIENTE)
);
...
DROP DATABASE SISTEMA_DE_GESTAO_EMPRESARIAL1;